...
os.environ["GOOGLE_APPLICATION_CREDENTIAL"] == st.secrets["secret_key"]
...
if input_option == '直接入力':
    input_data = st.text_area(
        'こちらにテキストを入力してください', 'cloud Speech-test用のサンプル文になります')
else:
...
if input_data is not None:
    ...
    lang = st.selectbox('言語を選択してください',
                        ('日本語', '英語')
                        )
    gender = st.selectbox('言語を選択してください',
